...
const Todo = () => {
  ...
  return (
    <div className='text-black bg-white place-self-center w-11/12 max-w-md flex flex-col p-7 min-h-[550px] rounded-md'>
      ...
      <div className='flex items-center my-7 bg-gray-200 rounded-full'>
        ...
        <button onClick={add} className='border-none rounded-full bg-orange-500 w-32 h-14
